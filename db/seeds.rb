...
34.times do |index|
  product = Product.create!(name: Faker::Beer.unique.name, 
  ...
  5.times do |index|
    ...
    Review.create!(author: Faker::Name.unique.name, 
                    ...
                    content_body: Faker::Lorem.paragraph_by_chars(number: x, supplemental: false), 
                    rating: Faker::Number.within(range: 1..5))
  end
end

1.times do |index|
  product = Product.create!(name: "Apex Legends", 
                            cost: Faker::Number.decimal(l_digits: 2), 
